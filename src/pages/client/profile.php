            ...
            <div class="profile-layout">
                ...
                <div class="profile-card">
                    <div class="profile-avatar-section">
                        <img
                                src="<?= e(uploadUrl(currentPicture(), 'profiles')) ?>"
                                alt="Avatar"
                        ...
                        <div>
                            ...
                            <p class="text-muted text-sm">Member
                                since <?= formatDate($client->getCreatedAt(), 'M Y') ?></p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-zone" style="padding: 1rem;">
                                ...
                                <img class="upload-preview" id="avatar-new-preview" alt="New preview"
                                     style="max-height:100px; margin: 0.5rem auto 0;">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name"
                                   class="form-control <?= isset($errors['full_name']) ? 'is-error' : '' ?>"
